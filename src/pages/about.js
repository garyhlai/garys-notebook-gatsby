    ...
    <div>
      <Layout>
        ...
        <p>
          ...
          recently graduated from Columbia University in NYC and set out to
        ...
        <p>
          ...
          lifestyle. I have been programming for two years but mostly just class
          projects, nothing serious. Now I have more time, I am super excited to
          unleash my creativity and actually ship things.{" "}
        </p>
        <p>
          ...
          By explaining things, I can understand them better while providing
          values to others. Meanwhile, I hope to connect with and learn from
          fellow programmers and travelers who find my blog posts useful.
        </p>
        <p>
